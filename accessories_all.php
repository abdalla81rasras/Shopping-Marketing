                ...
                <div class="col-12 col-md-6 mb-3 mb-md-0">
                    <nav class="Shop-grid-nav">
                        <ul class="nav nav-pills align-items-center" id="pills-tab" role="tablist">
                            ...
                            <?php
                                $query = "SELECT * FROM prudocts WHERE `Products_sub_Category`='All-ACCESSORIES'";
                    ...
                    <form action="" method="post">
                        <div class="Shop-grid-button d-flex align-items-center">
                            ...
                            <select class="form-control-sm" name="option">
                                ...
                                <option class="dropdown-item list-group-item list-group-item-action" value="sub_cat_acc_all"><a href="#"> <?php echo $language['Sub categories'] ?></a></option>
                                <option class="dropdown-item list-group-item list-group-item-action" value="high_price_acc_all"><a href="#"> <?php echo $language['High price to low'] ?></a></option>
                                <option class="dropdown-item list-group-item list-group-item-action" value="high_rite_acc_all"><a href="#"> <?php echo $language['High rate to low'] ?></a></option>
                                <option class="dropdown-item list-group-item list-group-item-action" value="views_acc_all"><a href="#"> <?php echo $language['Products View'] ?></a></option>
                            </select>
