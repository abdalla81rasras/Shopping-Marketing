                ...
                <div class="col-12 col-md-6 mb-3 mb-md-0">
                    <nav class="Shop-grid-nav">
                        <ul class="nav nav-pills align-items-center" id="pills-tab" role="tablist">
                            ...
                            <?php
                                $query = "SELECT * FROM prudocts WHERE `Products_sub_Category`='Makeup-OTHERS'";
                    ...
                    <form action="" method="post">
                        <div class="Shop-grid-button d-flex align-items-center">
                            ...
                            <select class="form-control-sm" name="option">
                                ...
                                <option class="dropdown-item list-group-item list-group-item-action" value="sub_cat_makeup"><a href="#"> <?php echo $language['Sub categories'] ?></a></option>
                                <option class="dropdown-item list-group-item list-group-item-action" value="high_price_makeup"><a href="#"> <?php echo $language['High price to low'] ?></a></option>
                                <option class="dropdown-item list-group-item list-group-item-action" value="high_rite_makeup"><a href="#"> <?php echo $language['High rate to low'] ?></a></option>
                                <option class="dropdown-item list-group-item list-group-item-action" value="views_makeup"><a href="#"> <?php echo $language['Products View'] ?></a></option>
                            </select>
                    ...
                    if(isset($_POST['submit_option'])){
                        ...
                        switch( $_POST['option'] ){
                            case 'sub_cat_makeup':
                                ...
                                break;
                            case 'high_price_makeup':
                                $query .= " ORDER BY Product_Price DESC";
                                break;
                            case 'high_rite_makeup':
