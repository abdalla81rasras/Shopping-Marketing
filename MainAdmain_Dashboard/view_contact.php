      ...
      <div class="sidebar-wrapper" style="overflow-x:hidden ;">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-success" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item active" href="./view_contact.php">View All</a>
              <div class="dropdown-divider"></div>
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          <td><?php echo $row['title_contact']; ?></td>
                          <td><?php echo $row['address_contact']; ?></td>
                          <td><?php echo $row['phone_contact']; ?></td>
                          <td><?php echo $row['phone_hotline_contact']; ?></td>
                          <td><?php echo $row['email_contact']; ?></td>
                          <td><?php echo $row['email_support_contact']; ?></td>
                          <td>
                            <a href="./add_contact.php?edit_contact=<?php echo $row['id_contact']; ?>"><i class="fa fa-edit" title="edit" style="font-size:16px;"></i></a>
                          </td>
                        </tr>
                      <?php endwhile; ?>
                    </tbody>
