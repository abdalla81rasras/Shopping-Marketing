      ...
      <div class="sidebar-wrapper" style="overflow-x:hidden ;">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-success" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item active" href="./view_intro.php">View All</a>
              <div class="dropdown-divider"></div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">View Intro For the Admin Store</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    ?>
                      <tr>
                        <td>
                          <video src="../upload_intro/<?php echo $row['vid_intro'] ?>" width="400px" controls></video>
                        </td>
                        <td>
                          <a href="./add_intro.php?edit_intro=<?php echo $row['id_intro']; ?>"><i class="fa fa-edit" title="edit" style="font-size:20px;"></i></a>
                        </td>
                      </tr>
                    <?php endwhile; ?>
                    </tbody>
