      ...
      <div class="sidebar-wrapper" style="overflow-x:hidden ;">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-success" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item active" href="./view_messages.php">View All</a>
            </div>
          </li>
          <li class="nav-item">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="./add_contact.php?delete_form_contact=<?php echo $row['id_form_contact']; ?>"><i class="fa fa-trash" title="delete" style="font-size:16px;"></i></a>
                          </td>
                        </tr>
                      <?php endwhile; ?>
                    </tbody>
