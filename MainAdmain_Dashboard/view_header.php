        ...
        <ul class="nav">
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-success" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item active" href="./view_header.php">View All</a>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">View Header</h4>
              </div>
              <div class="card-body">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          <td>
                            <img src="../Upload_main_admin/<?php echo $row['img_logo']; ?>" title="<?php echo $row['img_logo']; ?>" alt="<?php echo $row['img_logo']; ?>" width="150px">
                          </td>
                          <td>
                            <img src="../Upload_main_admin/<?php echo $row['dash_logo']; ?>" title="<?php echo $row['dash_logo']; ?>" alt="<?php echo $row['dash_logo']; ?>" width="150px">
                          </td>
                          <td><?php echo $row['dash_name']; ?></td>
                          <td>
                            <a href="./add_header.php?edit_header=<?php echo $row['id_header']; ?>"><i class="fa fa-edit" title="edit" style="font-size:16px;"></i></a>
                          </td>
                        </tr>
                      <?php endwhile; ?>
                    </tbody>
