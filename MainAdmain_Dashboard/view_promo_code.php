      ...
      <div class="sidebar-wrapper" style="overflow-x:hidden ;">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-success" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item active" href="./view_promo_code.php">View All</a>
              <div class="dropdown-divider"></div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">View Promo Code</h4>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="./add_promo_code.php?edit_promo_code=<?php echo $row['id_promo_code']; ?>"><i class="fa fa-edit" title="edit" style="font-size:16px;"></i></a>
                            <span style="font-size:16px;">|</span>
                            <a href="./add_promo_code.php?delete_promo_code=<?php echo $row['id_promo_code']; ?>"><i class="fa fa-trash" title="delete" style="font-size:16px;"></i></a>
                          </td>
                        </tr>
                      <?php endwhile; ?>
                    </tbody>
