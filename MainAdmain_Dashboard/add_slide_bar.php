        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-success" aria-labelledby="navbarDropdownMenuLink">
              ...
              <div class="dropdown-divider"></div>
              <a class="dropdown-item active" href="./add_slide_bar.php">Add New</a>
            </div>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="card card-user">
              <div class="card-header">
                <?php if($update==true || $edit==true): ?>
                    <h5 class="card-title">Update Slide Bar</h5>
                <?php else: ?>
                    <h5 class="card-title">Add Slide Bar</h5>
                <?php endif; ?>
              </div>
              <div class="card-body pt-1">
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Image : size(1920X840)</label>
                        <input type="file" class="form-control" name="img_slider_bar" accept="image/*">
                        <div class="text-danger mt-1"><?php echo $errors['img_slider_bar'] ?></div>
                        <?php if($edit==true): ?>
                          <div class="text-warning mt-1 mb-2"><?php echo $errors['edit_img_slider_bar'] ?></div>
                          <p class="text-success font-weight-bold mr-2 d-inline">Old Image :</p>
                          <img src="../Upload_main_admin/<?php echo htmlspecialchars($img_slider_bar); ?>" title="<?php echo htmlspecialchars($img_slider_bar); ?>" alt="<?php echo htmlspecialchars($img_slider_bar); ?>" style="width:170px;">
                        <?php endif; ?>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea class="form-control textarea" name="description_slide_bar" placeholder="Enter Description"><?php echo htmlspecialchars($description_slide_bar); ?></textarea>
                        <div class="text-danger mt-1"><?php echo $errors['description_slide_bar'] ?></div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>link button :</label>
                        <input type="text" class="form-control" name="btn_slider" value="<?php echo htmlspecialchars($btn_slider); ?>" placeholder="Enter Link">
                        <div class="text-danger mt-1"><?php echo $errors['btn_slider'] ?></div>
                      </div>
                    </div>
                  </div>
                  <div class="row justify-content-around">
                    <?php if($update==true): ?>
                      <button name="update_slide_bar" type="submit" class="btn btn-success btn-round">Update</button>
                    <?php else: ?>
                      <button name="save_slide_bar" type="submit" class="btn btn-success btn-round">Save</button>
                    <?php endif; ?>
                      <button name="cancel_slide_bar" type="submit" class="btn btn-success btn-round">Cancel</button>
                  </div>
                </form>
              </div>
            </div>
