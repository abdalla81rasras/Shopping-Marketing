      ...
      <div class="sidebar-wrapper" style="overflow-x:hidden ;">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-success" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item active" href="./view_inner_slider.php">View All</a>
              <div class="dropdown-divider"></div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">View Inner Sliders</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                    <?php 
                      $select="SELECT * FROM `inner_slider_banner`";
                      $query=mysqli_query($conn , $select);
                      while($row=mysqli_fetch_assoc($query)):
                    ?>
                      <tr>
                        <td>
                          <img src="../Upload_main_admin/<?php echo $row['banner'] ?>" title="<?php echo $row['banner'] ?>" alt="<?php echo $row['banner'] ?>"height="150px">
                        </td>
                        <td>
                          <a href="./add_inner_slider.php?edit_inner_slider_banner=<?php echo $row['id_inner_slider_banner']; ?>"><i class="fa fa-edit" title="edit" style="font-size:16px;"></i></a>
                        </td>
                      </tr>
                    <?php endwhile; ?>
                    </tbody>
