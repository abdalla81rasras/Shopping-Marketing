      ...
      <div class="sidebar-wrapper" style="overflow-x:hidden ;">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-success" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item active" href="./view_us1.php">View All</a>
              <div class="dropdown-divider"></div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">View Offer Section 1 Under Slide</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      <?php 
                        $select="SELECT * FROM `under_slider_one`";
                        $query=mysqli_query($conn , $select);
                        while($row=mysqli_fetch_assoc($query)):
                      ?>
                        <tr>
                          <td><?php echo $row['title_under_one_1']; ?></td>
                          <td><?php echo $row['title_under_one_2']; ?></td>
                          <td><?php echo $row['discount_under_one']; ?>%</td>
                          <td><?php echo $row['link_under_one']; ?></td>
                          <td>
                            <img src="../Upload_main_admin/<?php echo $row['img_under_one'] ?>" title="<?php echo $row['img_under_one'] ?>" alt="<?php echo $row['img_under_one'] ?>" width="150px">
                          </td>
                          <td>
                            <a href="./add_us1.php?edit_under_one=<?php echo $row['id_under_one']; ?>"><i class="fa fa-edit" title="edit" style="font-size:16px;"></i></a>
                          </td>
                        </tr>
                      <?php endwhile; ?>
                    </tbody>
