      ...
      <div class="sidebar-wrapper" style="overflow-x:hidden ;">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-success" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item active" href="./view_feedback.php">View All</a>
              <div class="dropdown-divider"></div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">View Our Partners Feedbacks</h4>
              </div>
              <div class="card-body">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          <td>
                            <img src="../Upload_main_admin/<?php echo $row['img_feedback'] ?>" title="<?php echo $row['img_feedback'] ?>" alt="<?php echo $row['img_feedback'] ?>" width="150px">
                          </td>
                          <td><?php echo $row['description_feedback']; ?></td>
                          <td><?php echo $row['name_feedback']; ?></td>
                          <td><?php echo $row['email_feedback']; ?></td>
                          <td>
                            <a href="./add_feedback.php?edit_feedback=<?php echo $row['id_feedback']; ?>"><i class="fa fa-edit" title="edit" style="font-size:16px;"></i></a>
                            <span style="font-size:16px;">|</span>
                            <a href="./add_feedback.php?delete_feedback=<?php echo $row['id_feedback']; ?>"><i class="fa fa-trash" title="delete" style="font-size:16px;"></i></a>
                          </td>
                        </tr>
                      <?php endwhile; ?>
                    </tbody>
